...
for rf in regions:
  ...
  new_path = f".github/workflows/perf-{region_name}.yml"
  with open(old_path, 'rt') as f:
    content = f.read()
  content = content.replace("Region", "Perf")
  content = content.replace(old_path, new_path)
  content = content.replace(f"jobs:\n  {region_name}", f"jobs:\n  perf-{region_name}")
  content = content.replace("uses: ./.github/workflows/region.yml", "uses: ./.github/workflows/perf-region.yml")
